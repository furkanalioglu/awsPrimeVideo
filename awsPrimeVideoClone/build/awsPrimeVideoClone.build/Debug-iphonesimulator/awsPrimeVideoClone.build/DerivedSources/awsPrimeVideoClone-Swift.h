...
#ifndef AWSPRIMEVIDEOCLONE_SWIFT_H
#define AWSPRIMEVIDEOCLONE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="awsPrimeVideoClone",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18awsPrimeVideoClone11AppDelegate")
...
SWIFT_CLASS("_TtC18awsPrimeVideoClone19DownloadsController")
...
SWIFT_CLASS("_TtC18awsPrimeVideoClone14FindController")
...
SWIFT_CLASS("_TtC18awsPrimeVideoClone20HeaderCollectionCell")
...
SWIFT_CLASS("_TtC18awsPrimeVideoClone8HomeCell")
...
@interface HomeCell (SWIFT_EXTENSION(awsPrimeVideoClone)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC18awsPrimeVideoClone18HomeCollectionCell")
...
SWIFT_CLASS("_TtC18awsPrimeVideoClone14HomeController")
...
SWIFT_CLASS("_TtC18awsPrimeVideoClone10HomeHeader")
...
@interface HomeHeader (SWIFT_EXTENSION(awsPrimeVideoClone)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
...
SWIFT_CLASS("_TtC18awsPrimeVideoClone17MainTabController")
...
SWIFT_CLASS("_TtC18awsPrimeVideoClone13SceneDelegate")
...
SWIFT_CLASS("_TtC18awsPrimeVideoClone16SplashController")
